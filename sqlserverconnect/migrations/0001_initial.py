# Generated by Django 3.1.4 on 2021-05-29 13:30

from django.db import migrations, models
import sqlserverconnect.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dob', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('transfer', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('previous', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('aadhar', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('aadhar_f', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('blood', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('caste', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('handicap', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('resident', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('guardian', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('other1', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('other2', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
                ('passphoto', models.ImageField(default='', upload_to=sqlserverconnect.models.Certificates.upload_path_handler)),
            ],
        ),
        migrations.CreateModel(
            name='insertData',
